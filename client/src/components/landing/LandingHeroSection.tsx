    ...
    <section className="px-6 pb-28 pt-24">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mb-10 max-w-xl text-balance text-lg leading-relaxed text-muted-foreground">
          PostPilot автоматизирует весь цикл контента: создание, AI-редактирование,
          планирование, публикацию через бота и аналитику — в одном рабочем пространстве.
        </p>

        <div className="flex flex-wrap items-center gap-4">
          <Link
            to="/register"
            className="inline-flex items-center gap-2 rounded-md bg-foreground px-6 py-3 text-sm font-medium text-background transition-colors hover:bg-foreground/85"
          >
            Начать бесплатно
            <ArrowRight size={15} />
          </Link>
          <a
            href="#workflow"
            className="inline-flex items-center gap-2 rounded-md border border-border px-6 py-3 text-sm text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground"
          >
            Как это работает
          </a>
        </div>
